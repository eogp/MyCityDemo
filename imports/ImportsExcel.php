...
//        $highestColumnIndexLugares = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString($highestColumnLugares); // e.g. 5
    ...
    public function insertPropiedad($celdas, $mes) {
        ...
        $propiedad->destino = $celdas[4];
        $propiedad->agua = $celdas[5];
        $propiedad->cloacas = $celdas[6];
        $propiedad->paviemnto = $celdas[7];
        $propiedad->luz = $celdas[8];
        $propiedad->gas = $celdas[9];
        $propiedad->deuda = $celdas[10];
        $propiedad->depto = $celdas[11];
        $propiedad->torre = $celdas[12];
        $propiedad->altura = $celdas[13];
        $propiedad->calle = $celdas[14];
        $propiedad->localidad = $celdas[15];
        $propiedad->partido = $celdas[16];
        $propiedad->provincia = $celdas[17];
        $propiedad->pais = $celdas[18];
        $propiedad->cp = $celdas[19];
        $propiedad->altitud = $celdas[20];
        $propiedad->longitud= $celdas[21];
        $propiedad->mes= $mes;
